...
<h1 className="text-2xl md:text-3xl font-bold text-gray-900">Dashboard Tư vấn viên</h1>
<p className="text-sm md:text-base text-gray-600 mt-1">Tổng quan hiệu suất và thu nhập của bạn</p>
</header>
