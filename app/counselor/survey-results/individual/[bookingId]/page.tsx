...
export default async function IndividualSurveyResultsPage({ params, searchParams }: IndividualSurveyResultsPageProps) {
  ...
  return (
    <div className="space-y-6">
      <IndividualSurveyResults bookingId={bookingId} memberName={memberName} memberId={memberId} />
    </div>
  )
}
