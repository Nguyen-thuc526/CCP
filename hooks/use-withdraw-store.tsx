...
import { getWithdrawByStatus, updateWithdrawStatus } from "@/services/withdrawService"

export function useWithdrawStore() {
  const [withdraws, setWithdraws] = useState<Record<WithdrawStatus, Withdraw[]>>({
  ...
  const updateStatus = async (
    ...
    try {
      ...
      showToast("Cập nhật trạng thái rút tiền thành công", ToastType.Success)
    } catch (error) {
