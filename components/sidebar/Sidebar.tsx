...
export function Sidebar() {
  ...
  const counselorLinks: SidebarItem[] = [
    ...
    },
    {
      ...
      children: [
        ...
        { href: "/counselor/payments", icon: <CreditCard className="h-5 w-5" />, title: "Chính sách" },
      ],
    },
  ];
  ...
  return (
    <div className={cn("h-screen sticky top-0 flex flex-col border-r bg-white dark:bg-gray-950 transition-all duration-300", collapsed ? "w-20" : "w-64")}>
      <Button
        variant="ghost"
        size="icon"
            ...
            isGroup(item) ? (
              <div key={item.title}>
                ...
                >
                  ...
                  {!collapsed && <ChevronDown className={cn("h-4 w-4 transition", openGroups[item.title] ? "rotate-180" : "")} />}
                </button>
