...
export function PreJoin({
         ...
         try {
            ...
            if (err instanceof DOMException) {
               if (err.name === 'NotFoundError') {
                  ...
                  errorMessage =
                     'Bạn đã từ chối quyền truy cập camera hoặc microphone. Vui lòng cấp quyền để tiếp tục.';
               } else {
   ...
   const handleJoin = async () => {
      ...
      try {
         ...
         const roomNameFromToken =
            decodedToken?.room || `room_${appointmentId}`;

         console.log('Decoded token:', {
            participantName: participantNameFromToken,
            room: roomNameFromToken,
         });
         onJoin(
            videoEnabled,
            audioEnabled,
