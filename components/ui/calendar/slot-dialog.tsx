...
export function SlotDialog({ open, onOpenChange, selectedDate, onSubmit }: SlotDialogProps) {
            ...
            <Form className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Select value={values.startHour} onValueChange={(value) => setFieldValue("startHour", value)}>
                    <SelectTrigger>
                  ...
                  <ErrorMessage name="startHour" component="p" className="text-red-500 text-sm" />
                </div>
                <div className="space-y-2">
                  ...
                  <ErrorMessage name="endHour" component="p" className="text-red-500 text-sm" />
                </div>
              </div>
              <div className="space-y-2">
