                     ...
                     <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                        <div className="space-y-2">
                           ...
                           <Select>
                              ...
                              <SelectContent>
                                 <SelectItem value="ts-tran-van-c">
                                    TS. Trần Văn C
                                 </SelectItem>
                                 <SelectItem value="ts-pham-van-f">
                                    TS. Phạm Văn F
                                 </SelectItem>
                                 <SelectItem value="ts-ngo-thi-i">
                                    TS. Ngô Thị I
                                 </SelectItem>
                                 <SelectItem value="ts-vu-van-l">
                                    TS. Vũ Văn L
                                 </SelectItem>
                              </SelectContent>
                           </Select>
            ...
            <TabsContent value="content" className="space-y-6">
               <Card>
                  <CardHeader>
                     ...
                     <CardDescription>
                        Viết nội dung chi tiết cho bài viết của bạn
                     </CardDescription>
                  </CardHeader>
                  <CardContent>
                     <div className="space-y-2">
            ...
            <TabsContent value="settings" className="space-y-6">
               <Card>
                  <CardHeader>
                     ...
                     <CardDescription>
                        Cấu hình các tùy chọn cho bài viết của bạn
                     </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                     <div className="space-y-2">
                        ...
                        <p className="text-xs text-muted-foreground">
                           Đường dẫn sẽ được tạo tự động từ tiêu đề nếu để trống
                        </p>
                     </div>
                     <div className="space-y-2">
                        ...
                        />
                        <p className="text-xs text-muted-foreground">
                           Tối đa 160 ký tự để hiển thị tốt trên các công cụ tìm
                           kiếm
                        </p>
                     </div>
                     <div className="space-y-2">
