          ...
          <table className="w-full caption-bottom text-sm">
            <thead className="border-b">
              <tr className="border-b transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted">
                <th className="h-12 px-4 text-left align-middle font-medium">Chuyên viên tư vấn</th>
                ...
                >
                  <td className="p-4 align-middle">
                    <div className="flex items-center gap-3">
                      <Avatar>
                        <AvatarImage src={`/placeholder.svg?height=40&width=40`} alt={counselor.name} />
                        <AvatarFallback>
                  ...
                  <td className="p-4 align-middle">{counselor.specialty}</td>
                  <td className="p-4 align-middle">{counselor.clients}</td>
                  <td className="p-4 align-middle">
                    <Badge variant={counselor.status === "Hoạt động" ? "default" : "secondary"}>
                      {counselor.status}
                    </Badge>
                  </td>
                  <td className="p-4 align-middle">
