          ...
          <div className="space-y-4">
            <div className="flex items-center gap-4">
              <Avatar className="h-16 w-16">
                <AvatarImage src={selectedUser.avatar || "/placeholder.svg"} alt={selectedUser.fullName || selectedUser.email} />
                <AvatarFallback>{(selectedUser.fullName || selectedUser.email)[0]}</AvatarFallback>
              </Avatar>
              <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p>{selectedUser.lastActive ? formatDateTime(selectedUser.lastActive) : "Chưa có"}</p>
              </div>
