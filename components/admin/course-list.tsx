          ...
          <table className="w-full caption-bottom text-sm">
            <thead className="border-b">
              <tr className="border-b transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted">
                ...
                <th className="h-12 px-4 text-left align-middle font-medium">Giảng viên</th>
                <th className="h-12 px-4 text-left align-middle font-medium">Lượt đăng ký</th>
            ...
            <tbody>
              {courses.map((course) => (
                ...
                >
                  ...
                  <td className="p-4 align-middle">{course.enrollments}</td>
                  <td className="p-4 align-middle">
                    <Badge variant={course.status === "Đã xuất bản" ? "default" : "secondary"}>{course.status}</Badge>
                  </td>
                  <td className="p-4 align-middle">
