...
export function ReportCharts() {
   ...
   const surveyData = [
      {
         type: 'Khảo sát trước tư vấn',
         completed: 856,
         started: 1024,
         completionRate: 84,
      },
      {
         type: 'Đánh giá sau tư vấn',
         completed: 742,
         started: 856,
         completionRate: 87,
      },
   ...
   return (
      <Card>
         <CardHeader>
            ...
            <CardDescription>
               Hiệu suất nền tảng cho giai đoạn đã chọn
            </CardDescription>
         </CardHeader>
         <CardContent>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                     ...
                     <Card>
                        <CardHeader>
                           ...
                           <CardDescription>
                              Số lượng thành viên mới và tổng thành viên theo
                              tháng
                           </CardDescription>
                        </CardHeader>
                        <CardContent>
                     ...
                     <Card>
                        <CardHeader>
                           ...
                           <CardDescription>
                              Tỷ lệ các gói membership hiện tại
                           </CardDescription>
                        </CardHeader>
                        <CardContent>
                           <ResponsiveContainer width="100%" height={300}>
                     ...
                     <Card className="lg:col-span-2">
                        <CardHeader>
                           ...
                           <CardDescription>
                              Số lượng nâng cấp lên gói Premium theo tháng
                           </CardDescription>
                        </CardHeader>
                        <CardContent>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                     ...
                     <Card>
                        <CardHeader>
                           ...
                           <CardDescription>
                              Số lượng lịch hẹn và tỷ lệ hoàn thành
                           </CardDescription>
                        </CardHeader>
                        <CardContent>
                           <ResponsiveContainer width="100%" height={300}>
                     ...
                     <Card>
                        <CardHeader>
                           ...
                           <CardDescription>
                              Điểm đánh giá trung bình của từng tư vấn viên
                           </CardDescription>
                        </CardHeader>
                        <CardContent>
                           <ResponsiveContainer width="100%" height={300}>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                     ...
                     <Card>
                        <CardHeader>
                           ...
                           <CardDescription>
                              Tỷ lệ hoàn thành lịch hẹn theo tháng
                           </CardDescription>
                        </CardHeader>
                        <CardContent>
                           <ResponsiveContainer width="100%" height={250}>
                     ...
                     <Card>
                        <CardHeader>
                           <CardTitle className="text-lg">
                              Tổng kết tháng gần nhất
                           </CardTitle>
                           <CardDescription>
                              Phân tích chi tiết tháng 12
                           </CardDescription>
                        </CardHeader>
                        <CardContent>
                           <ResponsiveContainer width="100%" height={250}>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                     ...
                     <Card className="lg:col-span-2">
                        <CardHeader>
                           ...
                           <CardDescription>
                              So sánh số lượng bắt đầu và hoàn thành theo loại
                              khảo sát
                           </CardDescription>
                        </CardHeader>
                        <CardContent>
                     ...
                     <Card>
                        <CardHeader>
                           ...
                           <CardDescription>
                              Phần trăm hoàn thành theo loại khảo sát
                           </CardDescription>
                        </CardHeader>
                        <CardContent>
                           <ResponsiveContainer width="100%" height={250}>
                     ...
                     <Card>
                        <CardHeader>
                           ...
                           <CardDescription>
                              Tỷ lệ các loại khảo sát được hoàn thành
                           </CardDescription>
                        </CardHeader>
                        <CardContent>
                           <ResponsiveContainer width="100%" height={250}>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                     ...
                     <Card className="lg:col-span-2">
                        <CardHeader>
                           ...
                           <CardDescription>
                              Đăng ký, hoàn thành và bỏ học theo tháng
                           </CardDescription>
                        </CardHeader>
                        <CardContent>
                           <ResponsiveContainer width="100%" height={350}>
                           ...
                           <ResponsiveContainer width="100%" height={250}>
                              <AreaChart
                                 data={courseData.map((item) => ({
                                    ...item,
                                    completionRate: (
                                       (item.completions / item.enrollments) *
                                       100
                                    ).toFixed(1),
                                 }))}
                              >
