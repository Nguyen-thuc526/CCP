    ...
    <div className="flex items-center justify-between border-b pb-4 mb-6">
      ...
      <div className="flex items-start gap-4 ">
        <div className="flex flex-col">
          <h1 className="w-[800px] text-2xl font-bold text-gray-900 leading-tight">{props.title}</h1>
          <p className="text-sm text-muted-foreground">Chi tiết khóa học</p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-2">
        ...
        <Switch id="course-status-toggle" checked={props.status === "public"} onCheckedChange={handleToggleStatus} />
      </div>
    </div>
  )
}
