...
interface QuizBuilderProps {
  ...
  onUpdateQuestion?: (questionId: string, questionData: any, chapterId: string) => Promise<boolean>
...
export default function QuizBuilder({
  ...
  const updateEditingAnswer = (index: number, field: "text" | "points", value: string | number) => {
    if (!editingQuestion) return
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleAnswerChange(
                        index,
                        "points",
                        Math.min(10, Math.max(1, Number.parseInt(e.target.value) || 1)),
                      )
                    }
