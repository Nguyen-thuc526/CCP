...
export function PersonalityCard({ personType, onView, onEdit }: PersonalityCardProps) {
  return (
    <Card className="overflow-hidden group hover:shadow-lg transition-shadow duration-300">
      ...
      <CardHeader className="pb-3 relative">
        ...
        <div className="pt-10">
          <CardTitle className="text-xl font-bold text-gray-900 mb-1">{personType.name}</CardTitle>
        </div>
      </CardHeader>
  ...
  return (
    <div className="p-8 bg-gray-50 min-h-screen">
      <div className="max-w-sm mx-auto">
        <PersonalityCard personType={samplePersonType} onView={handleView} onEdit={handleEdit} />
      </div>
    </div>
  )
}
