...
const ViewPersonalityModal = ({ personType, isOpen, onClose }: ViewPersonalityModalProps) => {
          ...
          <div className="relative px-6 pt-4 pb-2">
            <div className="absolute -top-10 left-6">
              <Avatar className="h-20 w-20 border-4 border-white shadow-lg">
                <AvatarImage src={personType.image || "/placeholder.svg"} alt={personType.name} />
            ...
            <div className="pt-12">
              <DialogTitle className="text-2xl font-bold text-gray-900">{personType.name}</DialogTitle>
            </div>
          </div>

          <div className="space-y-6 px-6 pb-6">
            <div>
              <h4 className="font-semibold mb-3 text-lg text-gray-800">Mô Tả</h4>
              <p className="text-gray-600 leading-relaxed">{personType.description}</p>
            </div>

            <Separator />

            <div>
              <h4 className="font-semibold mb-3 text-lg text-gray-800">Nội Dung Chi Tiết</h4>
              <div
