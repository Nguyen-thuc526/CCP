...
export function EditPersonalityModal({ isOpen, onClose, onSubmit, categories, personType }: EditPersonalityModalProps) {
    ...
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>Cập nhật thông tin chi tiết của loại tính cách này.</DialogDescription>
        </DialogHeader>
