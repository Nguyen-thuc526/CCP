                  ...
                  <Tabs defaultValue="type1" className="w-full">
                     <TabsList className="grid w-full grid-cols-2 mb-6 bg-gray-100 rounded-lg">
                        ...
                        >
                           ...
                           <span>
                              {selectedComparison.personType?.name || 'Loại 1'}{' '}
                              - Chi Tiết
                           </span>
                        </TabsTrigger>
                        <TabsTrigger
                        ...
                        >
                           ...
                           <span>
                              {selectedComparison.personType2?.name || 'Loại 2'}{' '}
                              - Chi Tiết
                           </span>
                        </TabsTrigger>
                     </TabsList>
                        ...
                        <CardContent className="space-y-4">
                           ...
                           <div
                              ...
                              dangerouslySetInnerHTML={{
                                 __html:
                                    selectedComparison.personType?.detail ||
                        ...
                        <CardContent className="space-y-4">
                           <div className="flex items-center gap-4">
                              ...
                              <div>
                                 ...
                                 <CardDescription className="text-gray-600 mt-1">
                                    {selectedComparison.personType2
                                       ?.description || ''}
                                 </CardDescription>
                              </div>
                           </div>
                           <div
                              ...
                              dangerouslySetInnerHTML={{
                                 __html:
                                    selectedComparison.personType2?.detail ||
                                    'Không có thông tin chi tiết',
                              }}
                           />
                        </CardContent>
