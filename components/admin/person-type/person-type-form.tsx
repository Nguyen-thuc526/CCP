...
export function PersonalityForm({ categories, initialData, onDataChange }: PersonalityFormProps) {
  const { uploadImage, loading: uploading } = useUploadImage()
  const [formData, setFormData] = useState<Partial<PersonType>>(initialData || {})
  useEffect(() => {
