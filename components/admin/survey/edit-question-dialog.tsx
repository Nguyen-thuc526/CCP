...
export function EditQuestionDialog({
   ...
   const [editingQuestion, setEditingQuestion] =
      useState<SurveyQuestion>(question);
   const [loading, setLoading] = useState(false);
   const [error, setError] = useState<string | null>(null);
   const [newAnswerForm, setNewAnswerForm] = useState<SurveyAnswer>({
      text: '',
      score: 1,
      tag: '',
   });
   ...
   const [editingAnswerForm, setEditingAnswerForm] = useState<SurveyAnswer>({
      text: '',
      score: 1,
      tag: '',
   });
   ...
   const getAvailableTags = () => {
      ...
      if (surveyNameLower.includes('mbti')) {
         ...
         surveyNameLower.includes('love') ||
         surveyNameLower.includes('language')
      ) {
         return loveLanguageQuestionTags;
      } else if (
         surveyNameLower.includes('big') ||
         surveyNameLower.includes('5')
      ) {
      ...
      if (editingAnswerIndex !== null) {
         setEditingQuestion((prev) => ({
            ...
            answers: prev.answers.map((answer, index) =>
               index === editingAnswerIndex ? editingAnswerForm : answer
            ),
         }));
         setEditingAnswerIndex(null);
      ...
      <Dialog open={isOpen} onOpenChange={handleClose}>
         <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
            <DialogHeader>
               ...
               <DialogDescription>
                  Chỉnh sửa câu hỏi và các lựa chọn trả lời
               </DialogDescription>
            </DialogHeader>
            ...
            <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-3">
                     ...
                     <div>
                        ...
                        <Select
                           ...
                           onValueChange={(value) =>
                              setNewAnswerForm({ ...newAnswerForm, tag: value })
                           }
                        >
                           <SelectTrigger>
               ...
               <div>
                  <h4 className="font-medium mb-2">
                     Các Lựa Chọn Trả Lời ({editingQuestion.answers.length})
                  </h4>
                              ...
                              <div className="space-y-3">
                                 ...
                                 <div className="flex gap-2">
                                    <Button
                                       ...
                                       disabled={
                                          !editingAnswerForm.text ||
                                          !editingAnswerForm.tag
                                       }
                                    >
            ...
            <DialogFooter>
               ...
               <Button
                  ...
                  disabled={loading || editingAnswerIndex !== null}
               >
                  {loading ? (
                     'Đang lưu...'
                  ) : (
