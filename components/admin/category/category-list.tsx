...
import { Folder, FolderOpen, Tag, Pencil, MoreVertical, PlusCircle, Trash2 } from "lucide-react"
          ...
          return (
            ...
            >
              <CardHeader className="flex flex-row justify-between items-center cursor-pointer p-6 hover:bg-gradient-to-r hover:from-rose-50 hover:to-pink-50 transition-all duration-300">
                <div className="flex items-center space-x-4" onClick={() => toggleExpand(category.id)}>
                  <div
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end">
                    ...
                    <DropdownMenuItem onClick={() => setAddingSubCategory(category)}>
                      <PlusCircle className="w-4 h-4 mr-2" />
                      Thêm chủ đề con
                    </DropdownMenuItem>

                    <DropdownMenuItem className="text-destructive" onClick={() => onCategoryHidden(category.id)}>
