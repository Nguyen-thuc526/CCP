...
export function SurveyForm() {
  ...
  const [questions, setQuestions] = useState([{ id: 1, text: "", type: "multiple-choice", options: ["", ""] }])

  const addQuestion = () => {
    const newId = questions.length > 0 ? Math.max(...questions.map((q) => q.id)) + 1 : 1
    setQuestions([...questions, { id: newId, text: "", type: "multiple-choice", options: ["", ""] }])
  }
      ...
      <div className="space-y-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Nhập thông tin cơ bản về khảo sát</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="space-y-2">
              <Label htmlFor="title">Tiêu đề khảo sát</Label>
              <Input id="title" placeholder="Nhập tiêu đề khảo sát" required />
            </div>
            <div className="space-y-2">
              <Label htmlFor="description">Mô tả</Label>
              <Textarea id="description" placeholder="Mô tả ngắn về khảo sát này" rows={3} />
            </div>
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              <div className="space-y-2">
                ...
                <Select>
                  ...
                  <SelectContent>
                    <SelectItem value="personality">Tính cách</SelectItem>
                    <SelectItem value="relationship">Mối quan hệ</SelectItem>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between">
            <div>
              ...
              <CardDescription>Thêm các câu hỏi cho khảo sát của bạn</CardDescription>
            </div>
            ...
            {questions.map((question, index) => (
              <Card key={question.id} className="border border-dashed">
                ...
                <CardContent className="space-y-4 pt-0">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor={`question-type-${question.id}`}>Loại câu hỏi</Label>
                    <Select value={question.type} onValueChange={(value) => updateQuestion(question.id, "type", value)}>
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="single-choice">Một lựa chọn</SelectItem>
