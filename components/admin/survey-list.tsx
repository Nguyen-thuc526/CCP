          ...
          <table className="w-full caption-bottom text-sm">
            <thead className="border-b">
              <tr className="border-b transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted">
                ...
                <th className="h-12 px-4 text-left align-middle font-medium">Câu hỏi</th>
                <th className="h-12 px-4 text-left align-middle font-medium">Lượt hoàn thành</th>
            ...
            <tbody>
              {surveys.map((survey) => (
                ...
                >
                  ...
                  <td className="p-4 align-middle">{survey.questions}</td>
                  <td className="p-4 align-middle">{survey.completions}</td>
                  <td className="p-4 align-middle">
                    <Badge variant={survey.status === "Hoạt động" ? "default" : "secondary"}>{survey.status}</Badge>
                  </td>
                  <td className="p-4 align-middle">
