...
import { FilePlus, Loader2, X, ChevronDown, ChevronRight, CheckCircle, Clock } from 'lucide-react'
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.success) {
        ...
        showToast(response.message || "Nộp chứng chỉ thất bại.", ToastType.Error)
      }
    } catch (error: any) {
      ...
      <DialogContent className="sm:max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-3">
            <Label>Chọn danh mục (có thể chọn từ nhiều danh mục khác nhau)</Label>
          ...
          <div className="space-y-1">
            ...
            <Input ref={fileInputRef} id="cert-image" type="file" accept="image/*" onChange={handleFileChange} />
          </div>
