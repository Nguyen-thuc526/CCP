...
export default function PendingCertificates({ certifications, onUpdate }: PendingCertificatesProps) {
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-xl font-semibold">Chứng chỉ đang chờ duyệt</h2>
          <p className="text-sm text-muted-foreground">Danh sách các chứng chỉ đã nộp và đang chờ xét duyệt</p>
        </div>
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="text-center py-8">
              ...
              <h3 className="text-lg font-medium mb-2">Không có chứng chỉ nào đang chờ duyệt</h3>
              <p className="text-sm text-muted-foreground">
                Các chứng chỉ đã nộp sẽ hiển thị tại đây trong quá trình xét duyệt
              </p>
            </div>
          </CardContent>
        </Card>
                ...
                <div className="flex-1">
                  <CardHeader className="pb-3">
                    ...
                    <div className="flex items-center gap-2 text-sm text-muted-foreground">
                      ...
                      Nộp ngày {new Date(cert.time || "").toLocaleDateString("vi-VN")}
                    </div>
                  </CardHeader>
                  ...
                  <CardContent className="space-y-3">
                    ...
                    <div className="flex gap-2 pt-2">
                      <Button size="sm" variant="outline" onClick={() => handleViewDetail(cert)}>
        ...
        <CardContent className="pt-4">
          <div className="flex items-start gap-3">
            ...
            <div className="space-y-1">
              <h4 className="text-sm font-medium text-blue-900">Thông tin về quá trình duyệt</h4>
              <p className="text-sm text-blue-700">
                • Thời gian xét duyệt thông thường: 24-48 giờ làm việc
                <br />• Bạn sẽ nhận được thông báo qua email khi có kết quả
                <br />• Chứng chỉ được duyệt sẽ tự động chuyển sang tab "Chứng chỉ đã duyệt"
              </p>
            </div>
          </div>
        </CardContent>
