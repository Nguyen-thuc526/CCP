  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-xl font-semibold">Chứng chỉ đã được duyệt</h2>
          <p className="text-sm text-muted-foreground">Danh sách các chứng chỉ đã được xác minh và phê duyệt</p>
        </div>
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="text-center py-8">
              ...
              <h3 className="text-lg font-medium mb-2">Chưa có chứng chỉ nào được duyệt</h3>
              <p className="text-sm text-muted-foreground">Các chứng chỉ đã được phê duyệt sẽ hiển thị tại đây</p>
            </div>
          </CardContent>
        </Card>
      ) : (
            ...
            <Card key={cert.id} className="overflow-hidden">
              ...
              <CardHeader className="pb-3">
                ...
                <div className="flex items-center gap-2 text-sm text-muted-foreground">
                  ...
                  {cert.time ? new Date(cert.time).toLocaleDateString("vi-VN") : "Chưa có thời gian"}
                </div>
              </CardHeader>
              ...
              <CardContent className="space-y-3">
                ...
                <div className="flex gap-2 pt-2">
                  <Button size="sm" variant="outline" className="flex-1" onClick={() => handleViewDetail(cert)}>
