...
export default function CertificateList({ certifications }: CertificateListProps) {
  ...
  const handleUpdateCertificate = (updatedCert: Certification) => {
    // TODO: cập nhật lại list theo nhu cầu (fetch lại / setState tại chỗ)
    console.log('Updated certificate:', updatedCert);
    // Nếu bạn đang giữ list trong state, có thể map để thay thế phần tử tương ứng ở đây.
  };
            ...
            <Card key={cert.id} className="overflow-hidden">
              ...
              <CardContent className="space-y-3">
                ...
                <div className="border-t pt-3">
                  ...
                  {renderCategories(cert.categories as any[])}
                </div>
