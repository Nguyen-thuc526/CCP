                ...
                <div className="flex-1">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                      <div className="flex items-start gap-2">
                        ...
                        <div className="space-y-2">
                          ...
                          {cert.rejectionDetails && cert.rejectionDetails.length > 0 && (
                            <div className="mt-2">
                              <p className="text-xs font-medium text-red-800 mb-1">Chi tiết cần chỉnh sửa:</p>
                              <ul className="text-xs text-red-700 space-y-1">
                                {cert.rejectionDetails.map((detail: string, index: number) => (
                    ...
                    <div className="flex gap-2 pt-2">
                      <Button size="sm" onClick={() => handleEdit(cert)} className="bg-blue-600 hover:bg-blue-700">
