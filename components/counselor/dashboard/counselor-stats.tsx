  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
      ...
      <Card className="w-full">
        ...
        <CardContent>
          <div className="text-xl md:text-2xl font-bold">{appointmentsThisWeek}</div>
      ...
      <Card className="w-full">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <CardTitle className="text-sm font-medium">Buổi tư vấn đã hoàn thành</CardTitle>
          <MessageSquare className="h-4 w-4 text-muted-foreground" />
        </CardHeader>
        <CardContent>
          <div className="text-xl md:text-2xl font-bold">{completedSessions}</div>
      ...
      <Card className="w-full">
        ...
        <CardContent>
          <div className="text-xl md:text-2xl font-bold">{averageRating.toFixed(1)}/5</div>
