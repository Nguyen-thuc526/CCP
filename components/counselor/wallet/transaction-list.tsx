  ...
  const filteredTransactions = (tabValue: string) => {
    ...
    if (selectedMonth !== "all" || selectedYear !== "all") {
      filtered = filtered.filter((transaction) => {
        ...
        const monthMatch = selectedMonth === "all" || Number.parseInt(selectedMonth) === transactionMonth
        const yearMatch = selectedYear === "all" || Number.parseInt(selectedYear) === transactionYear
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        {transaction.clientName && (
                          <div className="text-sm text-muted-foreground">Tên tài khoản: {transaction.clientName}</div>
                        )}
