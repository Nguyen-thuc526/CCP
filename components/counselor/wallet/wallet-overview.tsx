...
export function WalletOverview({
   ...
   const availableForWithdrawal = Math.max(
      0,
      walletData.currentBalance - (walletData.pendingDeposit ?? 0)
   );
            ...
            <Card>
               ...
               <CardContent>
                  <div className="text-2xl font-bold">
                     {formatCurrency(walletData.thisMonthIncome)}
                  </div>
               </CardContent>
            </Card>
                  ...
                  <div className="flex items-start gap-3">
                     ...
                     <div className="space-y-2">
                        ...
                        <p className="text-sm text-blue-800 leading-relaxed">
                           Tiền từ các buổi tư vấn sẽ được tự động chuyển vào ví
                           của bạn sau <strong>24 giờ</strong> kể từ thời gian
                           booking được thực hiện.
                        </p>
                     </div>
                  </div>
               </CardContent>
