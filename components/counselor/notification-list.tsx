  ...
  const notifications = [
    {
      id: 1,
      title: "Lịch hẹn mới",
      message: "Bạn có lịch hẹn mới với Nguyễn Văn A & Nguyễn Thị B vào ngày 15/05/2025",
      time: "5 phút trước",
      type: "appointment",
      unread: true,
    },
    ...
    },
    {
      ...
      message: "Chính sách thanh toán đã được cập nhật. Vui lòng xem xét và xác nhận.",
      time: "1 ngày trước",
      type: "policy",
      unread: false,
    },
