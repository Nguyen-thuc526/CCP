...
export function CoupleSurveyResults({
   ...
   const renderMemberCard = (
      ...
      const bigFiveScores = parseScores(
         isFirst
            ? coupleData?.bigFiveDescription
            : coupleData?.bigFive1Description
      );
               ...
               <div className="flex items-center justify-between p-4 bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg">
                  <div className="flex items-center gap-3">
                     {coupleData.mbtiDetail.image && (
                        <img
                           src={
                              coupleData.mbtiDetail.image || '/placeholder.svg'
                           }
                           alt="Compatibility"
                     ...
                     <div>
                        <div className="text-2xl font-bold text-purple-900">
                           {coupleData.mbtiDetail.compatibility}%
                        </div>
                  ...
                  <div className="text-right">
                     <div className="font-semibold text-gray-900">
                        {coupleData.mbtiDetail.personType.name} &{' '}
                        {coupleData.mbtiDetail.personType2.name}
                     </div>
                     <div className="text-sm text-gray-600">
                        {coupleData.mbtiDetail.category.name}
                     </div>
                  </div>
               </div>

               <Progress
                  value={coupleData.mbtiDetail.compatibility}
                  className="h-3"
               />

               <p className="text-gray-700 leading-relaxed">
                  {coupleData.mbtiDetail.description}
               </p>
                        ...
                        <div className="space-y-4">
                           <div
                              ...
                              dangerouslySetInnerHTML={{
                                 __html: coupleData.mbtiDetail.detail,
                              }}
                           />
                           ...
                           {coupleData.mbtiDetail.weaknesses && (
                              <div className="p-4 bg-orange-50 rounded-lg">
                                 ...
                                 <div
                                    ...
                                    dangerouslySetInnerHTML={{
                                       __html: coupleData.mbtiDetail.weaknesses,
                                    }}
                                 />
                              </div>
                           )}
