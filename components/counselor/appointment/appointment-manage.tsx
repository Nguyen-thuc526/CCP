      ...
      {selectedDate && (
        <div className="mt-4 p-3 bg-blue-50 rounded-lg">
          ...
          <div className="flex items-center gap-2 mt-1">
            ...
            <div className="lg:col-span-3 space-y-4">
              ...
              <BookingTable bookings={selectedDateBookings} isLoading={loading} />
        ...
        <TabsContent value="history" className="space-y-4">
          <div className="space-y-4">
            ...
            <BookingTable bookings={paginatedHistoryBookings} isLoading={historyLoading} />
            ...
            {historyTotalPages > 1 && (
              <Pagination>
                <PaginationContent>
                  ...
                  {Array.from({ length: Math.min(historyTotalPages, 5) }).map((_, i) => {
                    const page = i + 1
                    return (
                      <PaginationItem key={page}>
