  ...
  const [history] = useState<AppointmentHistory[]>([
    {
      ...
      notes:
        "Buổi tư vấn diễn ra tốt. Cặp đôi đã hiểu rõ hơn về vấn đề giao tiếp và cam kết thực hiện các bước cải thiện mà chúng tôi đã thảo luận. Họ sẽ thực hành các kỹ thuật lắng nghe tích cực và đặt lịch hẹn tiếp theo trong 2 tuần.",
    },
    {
      id: 2,
      ...
      cancelReason: "Tôi có việc đột xuất không thể tham gia buổi tư vấn. Xin lỗi vì sự bất tiện này.",
    },
    {
      id: 3,
    ...
    },
    {
      ...
      notes:
        "Cặp đôi đã tham gia đầy đủ và tích cực. Họ đã nhận ra các vấn đề trong cách giao tiếp và đã thực hành các kỹ thuật mới trong buổi tư vấn.",
    },
    {
      id: 5,
      ...
      notes:
        "Đã tư vấn về cách lập ngân sách gia đình và quản lý tài chính chung. Cặp đôi đã hiểu rõ và cam kết thực hiện kế hoạch.",
    },
  ])
                  ...
                  >
                    ...
                    <td className="p-4 align-middle">
                      <div className="flex gap-2">
                        {appointment.status === "Đã hoàn thành" && appointment.notes && (
                        ...
                        {(appointment.status === "Đã hủy" || appointment.status === "Đã từ chối") && (
                          <Button size="sm" variant="outline" onClick={() => openNotesDialog(appointment)}>
