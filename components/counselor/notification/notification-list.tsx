        ...
        <CardHeader className="bg-gradient-to-r from-rose-50 to-pink-50 dark:from-rose-950/20 dark:to-pink-950/20">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <CardTitle className="text-xl">Danh sách thông báo</CardTitle>
            </div>
          ...
          {loading ? (
            ...
            <div className="flex items-center justify-center p-12">
              <div className="text-center">
                ...
                <h3 className="mt-4 text-lg font-medium text-gray-900 dark:text-gray-100">Chưa có thông báo</h3>
                <p className="mt-2 text-sm text-muted-foreground">Các thông báo mới sẽ xuất hiện tại đây</p>
              </div>
            </div>
          ) : (
            <div className="divide-y divide-gray-100 dark:divide-gray-800">
              {items.map((n, index) => {
                const created = n.createDate ? new Date(n.createDate).toLocaleString("vi-VN") : ""

                return (
                  <div key={n.id} className="group p-4 transition-colors hover:bg-gray-50 dark:hover:bg-gray-800/50">
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1 space-y-2">
                        <div className="flex items-start justify-between">
                          <h4 className="font-medium text-gray-900 dark:text-gray-100">Thông báo #{index + 1}</h4>
                          <Badge variant="outline" className="ml-2 shrink-0">
                            Mới
                          </Badge>
                        </div>

                        <p className="text-sm text-gray-600 dark:text-gray-300 leading-relaxed">{n.description}</p>
