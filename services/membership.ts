...
export const getAllMembership = async (): Promise<Membership[]> => {
    const response = await axiosInstance.get<MembershipResponse>("/api/MemberShip");
...
export const createMembership = async (
    ...
    const response = await axiosInstance.post<MembershipResponse>("/api/MemberShip", payload);
...
export const updateMembership = async (
    ...
    const response = await axiosInstance.put<MembershipResponse>("/api/MemberShip", payload);
